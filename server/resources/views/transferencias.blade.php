...
<div class="cabecera">
    ...
    <header class="title" style="padding-bottom:0px;margin:0px;">
        <h3 style="text-align:center;margin:0px;">COMPROBANTE DE INGRESO/EGRESO - TRANSFERENCIA </h3>

    </header>
    <p style="font-weight:bold;text-align:left;margin-top:5px;  font-size:17px; margin: 10px;">Registros: {{count($data )}}</p>
        ...
        <table id="customers">
            ...
            <tbody>
                ...
                <tr style="background-color:#E5E5E5;">
                    <td>{{ $dt['product'] }}</td>
                    <td>{{ $dt['warehouse_origin'] }}</td>
                    <td>{{ $dt['warehouse_destination'] }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
